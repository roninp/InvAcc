...
const AUDIENCE: { title: string; description: string; icon: typeof Users }[] = [
  {
    title: "Частные и институциональные инвесторы",
    description: "Всем кто использует активы фондового сектора Московской биржи и хочет держать портфель в заданном целевом соотношении долей.",
    icon: Users,
  },
  {
